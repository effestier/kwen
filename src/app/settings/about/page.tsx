        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {[
              ...
              { label: 'Terms of Service', description: 'Rules and guidelines' },
              { label: 'Community Guidelines', description: 'How to stay safe' },
              { label: 'Cookie Policy', description: 'How we use cookies' },
              { label: 'Open Source Licenses', description: 'Software we use' }
            ].map((item) => (
              <button key={item.label} className="w-full flex items-center justify-between p-3 rounded-lg bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] transition-colors">
