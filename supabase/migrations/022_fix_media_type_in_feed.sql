-- Fix: Include media_type in media JSON for feed and explore RPCs
-- This allows the frontend to distinguish video from image posts

-- Update get_discovery_feed to include media_type
...
-- Update get_explore_feed to include media_type
